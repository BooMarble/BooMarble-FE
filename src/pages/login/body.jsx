...
function Body() {
  return (
    <StyledBody>
      ...
      <StyledLink as={Link} to="https://accounts.google.com/o/oauth2/auth?client_id=792908248831-o01redqdqoehht1v5ht5151ik4kog7a4.apps.googleusercontent.com&redirect_uri=http://localhost:3000/login/oauth2/code/google&response_type=code&scope=https://www.googleapis.com/auth/userinfo.email%20https://www.googleapis.com/auth/userinfo.profile">google로 시작하기</StyledLink>
    </StyledBody>
  );
}
